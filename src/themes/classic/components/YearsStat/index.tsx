  ...
  return (
    <div className="w-full pb-16 lg:w-full lg:pr-16">
      ...
      <section className="mb-6 px-2 lg:px-0 lg:pl-6">
        <div className="inline-flex items-center rounded-full border border-[var(--color-hr)] bg-[var(--color-background)] px-4 py-1.5 text-xs font-semibold text-[var(--color-tx)] shadow-sm backdrop-blur-md sm:text-sm">
